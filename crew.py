...
task_email = Task(
    description=(
        ...
        "    <h3>Tweets</h3>\n"
        "    <ul>\n"
        "      [For each non-empty tweet in tweets_json, render a <li> with the tweet text,\n"
        "       followed by '✓ queued in Buffer' if its _pushed field is true, else '(Buffer push skipped)']\n"
        "    </ul>\n"
        "    <hr>\n"
        "    <h3>Sources</h3>\n"
